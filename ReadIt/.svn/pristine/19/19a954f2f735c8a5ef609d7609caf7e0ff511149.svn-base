		...
		<div class="content-header row">
			<div class="content-header-left col-md-9 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h2 class="content-header-title float-start mb-0">자주 묻는 질문</h2>
						<div class="breadcrumb-wrapper">
							<ol class="breadcrumb">
								<li class="breadcrumb-item ">Home</li>
								<li class="breadcrumb-item ">북적 라운지</li>
								<li class="breadcrumb-item active"><a href="#">자주 묻는 질문</a>
								</li>
							</ol>
						</div>
					</div>
		...
		<div class="row" style="margin: auto; padding-bottom: 20px; position: relative;">
			<div class="col-md-12" style="float: right;">
				...
				<button type="button"
					...
					onclick="OpenWindow('registForm.do','공지등록',900,850);">자주묻는질문 등록</button>
				</sec:authorize>	
				</div>
		</div>
					...
					<div id="accordionWrapa1" role="tablist"
						...
						<div class="card">
							<div class="card-header" style="padding-left: 20px;margin-left: 80px;padding-bottom: 5px;">
								<h4 class="card-title">자주 묻는 질문들을 모아 놓았습니다</h4>
							</div>
							<div class="card-body">
								<p class="card-text" style="border-left-width: 80px; margin-left: 90px;">
								 원하시는 질문이 없으실 경우 1:1 문의를 이용해주세요</p>
												...
												<div class="accordion-body" style="padding-bottom: 50px">
													...
													<sec:authorize access="hasRole('ROLE_ADMIN')"> 
														<div style="float: right;">
 														<input type="button" class="btn btn-success" value="수정하기" onclick="OpenWindow('detail.do?from=list&oq_no=${oftenQna.oq_no }','상세보기',800,700);"/>
														</div>
													</sec:authorize>	
													</div>
												</div>
