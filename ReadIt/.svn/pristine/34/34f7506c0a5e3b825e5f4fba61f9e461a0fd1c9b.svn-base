...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="" style="font-family: 'Noto Sans KR', sans-serif;">
			    		...
			    		<div class="card-header">
			    			<div class="card-title">
				       		...
				       		<div class="row col-12">	
				         		<div class="demo-inline-spacing mb-2 col-12" style="margin-left: 200px;">
...
<%--     <script src="<%=request.getContextPath()%>/resources/vuexy/html-version/Bootstrap5/vuexy-html-bootstrap5-admin-template/app-assets/js/scripts/forms/form-tooltip-valid.js"></script> --%>
    ...
    <%@ include file="./handlebarsSearchTemplateForDonation.jsp" %>
