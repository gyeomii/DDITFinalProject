...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/vuexy/html-version/Bootstrap5/vuexy-html-bootstrap5-admin-template/app-assets/css/pages/page-misc.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page" onload="javascript:window_onload()" >
    <!-- BEGIN: Content-->
                ...
                <div class="misc-wrapper"><a class="brand-logo" href="index.html">
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                        	<h2 class="mb-2">입고도서 등록 완료!</h2>
                            <p class="mb-2">완료된 입고 도서 목록은 도서관리 메뉴의 '기타관리'에서 확인할 수 있습니다.</p>
                            <a class="btn btn-primary mb-2 btn-sm-block" onclick="window.close();">1초 뒤 자동으로 종료됩니다.</a>
<%--                             <img class="img-fluid" src="<%=request.getContextPath()%>/resources/vuexy/html-version/Bootstrap5/vuexy-html-bootstrap5-admin-template/app-assets/images/pages/error.svg" alt="Error page" /> --%>
                        </div>
                    </div>
                </div>
                <!-- / Error page-->
    ...
    <script type="text/javascript">
    	function window_onload(){
        	setTimeout('go_url()',1000)  // 3초후 go_url() 함수를 호출한다.
    	 }
    	function go_url(){
