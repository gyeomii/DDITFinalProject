		...
		<div class="card">
			<div style="padding-left: 30px; padding-top: 30px;">
				...
				<button type="button" class="btn btn-flat-danger round  "
					id="notReviewListBtn" onclick="acyncMovePage('<%=request.getContextPath()%>/main/myBook/notReviewList.do')">리뷰 미작성 도서</button>
			</div>
		...
		<div class="card">
			<div style="padding-left: 30px; padding-top: 30px;">
				<button type="button" class="btn btn-flat-primary round "
					id="reviewListBtn">나의 리뷰</button>
				<button type="button" class="btn btn-flat-danger round active " id="">리뷰
					미작성 도서</button>
			</div>
			<div style="padding-top: 10px; padding-left: 10px;">
				<select class="form-control col-md-3" name="perPageNum"
			...
			<div class="modal-content" style="width: 1000px; height: 750px;">
				...
				<div class="modal-body pb-5 px-sm-0">
					<div class="px-sm-4 mx-50">
						<h1 class="text-center mb-1" id="referEarnTitle">리뷰 수정하기</h1>
						<hr>
						...
						<div class="card-body" style="padding: 0px;">
							<div class="row my-2">
								...
								<div class="col-12 col-md-7">
									<!--                                     <h4>나의 라임 오렌지 나무</h4> -->
									<!--                                     <span class="card-text item-company">By <a href="#" class="company-name">주제 마우루 지 바스콘셀로스</a></span> -->
									...
									<p class="card-text">
										저자 <span class="text-success" id="modalAuthor"></span>
									</p>
									<p class="card-text">
										출판사 <span class="text-success" id="modalPublisher"></span>
									</p>
									<p class="card-text">
										출판년도 <span class="text-success" id="modalPublishdate"></span>
									</p>
									<p class="card-text">
						...
						<input id="modifymodalRev_no" style="display: none;" value=""  name="rev_no">
							...
							<div>
								<textarea class="col-auto form-control" type="text" name="rev_content"
									id="modifyRev_content" placeholder="좋은  리뷰 남겨주시면  추첨을 통해 무료 배송 쿠폰 지급!!"></textarea>
							</div>
							<div class="col-lg-2 d-flex align-items-end"
								style="margin-left: 35%; margin-top: 5px;">
								<input type="button" class="btn btn-primary w-70" onclick="modify_go()" value="수정하기">
							</div>
						</form>
					</div>
				</div>
	...
	<div class="modal fade" id="registReview" tabindex="-1"
		...
		<div
			...
			<div class="modal-content" style="width: 1000px; height: 750px;">
				...
				<div class="modal-body pb-5 px-sm-0">
					<div class="px-sm-4 mx-50">
						<h1 class="text-center mb-1" id="referEarnTitle">리뷰 작성하기</h1>
						<hr>
						<!-- Product Details starts -->
						...
						<div class="card-body" style="padding: 0px;">
							<div class="row my-2">
								...
								<div class="col-12 col-md-7">
									...
									<p class="card-text">
										저자 <span class="text-success" id="notmodalAuthor"></span>
									</p>
									<p class="card-text">
										출판사 <span class="text-success" id="notmodalPublisher"></span>
									</p>
									<p class="card-text">
										출판년도 <span class="text-success" id="notmodalPublishdate"></span>
									</p>
									<p class="card-text">
					...
					<div class="px-sm-5 mx-50">
						...
						<input id="modalRent_no" style="display: none;" value=""  name="rent_no">
							...
							<div>
								<textarea class="col-auto form-control" type="text" name="rev_content"
									id="rev_content" placeholder="좋은  리뷰 남겨주시면  추첨을 통해 무료 배송 쿠폰 지급!!"></textarea>
							</div>
							<div class="col-lg-2 d-flex align-items-end"
								style="margin-left: 35%; margin-top: 5px;">
								<input type="button" class="btn btn-primary w-70" onclick="regist_go()" value="수정완료">
							</div>
						</form>
					</div>
				</div>
...
// 	   alert("키워드 : " + document.querySelector("input[name='keyword']").value)
...
출처: https://cofs.tistory.com/402 [CofS:티스토리]
