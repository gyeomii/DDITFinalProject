...
public class RentPageMaker {
	...
	private int displayPageNum = 6; // 한 페이지에 보여줄 페이지번호 개수
	
	RentCriteria cri = new RentCriteria();
	...
	public RentCriteria getCri() {
		return cri;
	}

	public void setCri(RentCriteria cri) {
		this.cri = cri;
	} 
