			...
			<section id="flatpickr">
				<div class="card" style="margin: 20px;">
					<div class="card-header">
						<h4 class="card-title">(멀티미디어 4실)일시 선택</h4>
					</div>
					<div class="card-body">
					<form id="registForm" action="regist" method="post" role="form">
						<div class="row justify-content-between">
								...
								<input type="hidden" name="fac_code" value="m4" id="fac_code"/>
			...
			<div class="card" style="margin: 20px;">
				...
				<div class="card-body" style="min-height: 430px">
					<c:forEach var="i" begin="1" end="2">
						<div class="container row" style="margin-left: 12px" >
							<c:forEach var="j" begin="1" end="2">
								<div class="col-md-6" style="float: none;">
									<button id="seatNum${i}0${j}" type="button" onclick="setSheetFunc(${i}0${j})" class="btn btn-outline-primary waves-effect btnSize" style="width: 250px; height: 200px">${i}0${j}</button>
								</div>
							</c:forEach>
						</div>
						<br>
