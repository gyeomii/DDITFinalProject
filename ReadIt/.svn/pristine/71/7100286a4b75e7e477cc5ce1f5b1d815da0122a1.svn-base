                            ...
                            <div class="swiper-centered-slides swiper-container p-1">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide rounded swiper-shadow" onclick="goPage('${webPath}/main/board/notice/list.do','M030100','ifr')" >
                                        ...
                                        <div class="swiper-text pt-md-1 pt-sm-50">공지사항</div>
                                    </div>
                                    <div class="swiper-slide rounded swiper-shadow" onclick="goPage('${webPath}/main/info/use.do','M010200','ifr')" >
                                        ...
                                        <div class="swiper-text pt-md-1 pt-sm-50">도서관 이용</div>
                                    </div>
                                    <div class="swiper-slide rounded swiper-shadow" onclick="goPage('${webPath}/main/ai/recommand1.do','M040000','ifr')" >
                                        ...
                                        <div class="swiper-text pt-md-1 pt-sm-50">AI 추천</div>
                                    </div>
                                    <div class="swiper-slide rounded swiper-shadow" onclick="goPage('${webPath}/main/search/wishbookList/list.do','M020500','ifr')" >
                                        ...
                                        <div class="swiper-text pt-md-1 pt-sm-50">희망도서신청</div>
                                    </div>
                                    ...
                                    <div class="swiper-slide rounded swiper-shadow" onclick="goPage('${webPath}/main/myInfo/mySmartLib.do','M050100','ifr')" >
                                        ...
                                        <div class="swiper-text pt-md-1 pt-sm-50">나의도서관</div>
                                    </div>
                                    </c:if>
         ...
         <div class="col-12">
             <div class="card">
                 <div class="card-header">
                     <h4 class="card-title">이벤트 / 행사 안내</h4>
                 </div>
                 <div class="card-body">
									...
									<div class="row breadcrumbs-top">
										<div class="col-10">
											<div>
												...
												<h2 class="content-header-title float-start mb-0" style="margin-left: 15px;">베스트도서</h2>
											</div>
										</div>
										<div class="col-2" style="padding-left: 60px;">
											<div onclick="goPage('${webPath}/main/search/bestList.do','M020400','ifr')" ><a href="#"><i data-feather='plus-square'></i>더보기</a></div>
										</div>				
									</div>
								</div>
							</div>
								...
								<div class="content-header-left col-12">
									<div class="row breadcrumbs-top">
										<div class="col-10">
											<div>
												<img src="${webPath}/resources/img/line.png" style="width:30px; float:left; padding-left: 5px;" />
												<h2 class="content-header-title float-start mb-0" style="margin-left: 15px;">도서관 일정</h2>
											</div>
										</div>
									</div>
								</div>
	                       ...
	                       <div class="content-header row" style="padding-top: 20px; padding-left: 20px;">
							...
							<div class="row breadcrumbs-top">
									   <div class="col-10">
											<div>
											<img src="${webPath}/resources/img/line.png" style="width:30px; float:left; padding-left: 5px;" />
											<h2 class="content-header-title float-start mb-0" style="margin-left: 15px;">추천도서</h2>
											</div>
										</div>
										<div class="col-2">
											<div onclick="goPage('${webPath}/main/search/recommandList.do','M020300','ifr')" ><a href="#"><i data-feather='plus-square'></i>더보기</a></div>
										</div>				
							</div>
							</div>
						</div>	
								...
								<div class="content-header-left col-12 mb-2">
									<div class="row breadcrumbs-top">
									   <div class="col-9">
											<div>
											<img src="${webPath}/resources/img/line.png" style="width:30px; float:left; padding-left: 5px;" />
											<h2 class="content-header-title float-start mb-0" style="margin-left: 15px;">도서관 통계</h2>
											</div>
										</div>
										<div class="col-3" style="border-left-width: 15px; padding-left: 40px;">
											<div onclick="goPage('${webPath}/main/info/statistics.do','M010400','ifr')" ><a href="#"><i data-feather='plus-square'></i>더보기</a></div>
										</div>				
									</div>
								</div>
                                <div class="card-body">
					...
					<table class="table table-bordered"  style="table-layout:fixed; text-align: center; border-color:white;">
						<tbody>
							<c:forEach items="${recenNotice }" var="notice" varStatus="status">
								<tr onclick="OpenWindow('${webPath}/main/board/notice/detail.do?from=list&notice_no=${notice.notice_no }','상세보기',800,700);">
    				   ...
    				   <div class="content-header row" style="padding-top: 20px; padding-left: 20px;">
							...
							<div class="row breadcrumbs-top">
									   <div class="col-10">
											<div>
											<img src="${webPath}/resources/img/line.png" style="width:30px; float:left; padding-left: 5px;" />
											<h2 class="content-header-title float-start mb-0" style="margin-left: 15px;">봉사 활동</h2>
											</div>
										</div>
										<div class="col-2">
											<div onclick="goPage('${webPath}/main/board/volBoard/list.do','M030500','ifr')" ><a href="#"><i data-feather='plus-square'></i>더보기</a></div>
										</div>				
							</div>
							</div>
						</div>	
					...
					<table class="table table-bordered"  style="table-layout:fixed; text-align: center; border-color:white;">
						<tbody>
							<c:forEach items="${recentVol }" var="vol" varStatus="status">
								<tr onclick="OpenWindow('${webPath}/main/board/volBoard/detail.do?from=list&vb_no=${vol.vb_no }','상세보기',1100,700);" >
									<!-- <td>${((cri.page-1) * 20) + status.count}</td> --> <!-- 1부터 -->
<%-- 									<td>${status.count}</td> <!-- 역순 --> --%>
