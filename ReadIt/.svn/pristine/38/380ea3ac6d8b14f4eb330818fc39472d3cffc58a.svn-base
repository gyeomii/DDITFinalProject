                        ...
                        <div class="col-xl-6 col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-sm-center align-items-start flex-sm-row flex-column">
                                        <h4 class="card-title" >도서량 그래프</h4> <span style="padding-left: 450px;">(단위 : 권)</span>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="card" style="height: 485px;">
                                <div class="card-header" style="position: relative;">
                                    <h4 class="card-title">도서 분류별 도서량</h4>
                                    <div style="text-align: right;">(단위 : 권)</div>
                                </div>
                                <div class="card-body">
			...
			<!-- end chart -->
                        ...
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">도서 보유 현황</h4>
                            </div>
...
<!-- 						    <tr>       -->
<!-- 						      <td class="type"> -->
<%-- 								<c:if test="${entry.key eq '0'}"> 총류</c:if> --%>
<%-- 								<c:if test="${entry.key eq '1'}"> 철학</c:if>					       --%>
<%-- 								<c:if test="${entry.key eq '2'}"> 종교</c:if>					       --%>
<%-- 								<c:if test="${entry.key eq '3'}"> 사회과학</c:if>					       --%>
<%-- 								<c:if test="${entry.key eq '4'}"> 자연과학</c:if>					       --%>
<%-- 								<c:if test="${entry.key eq '5'}"> 기술과학</c:if>					       --%>
<%-- 								<c:if test="${entry.key eq '6'}"> 예술</c:if>					       --%>
<%-- 								<c:if test="${entry.key eq '7'}"> 언어</c:if>					       --%>
<%-- 								<c:if test="${entry.key eq '8'}"> 문학</c:if>					       --%>
<%-- 								<c:if test="${entry.key eq '9'}"> 역사</c:if>					       --%>
<!-- 						      </td> -->
