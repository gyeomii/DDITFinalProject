				...
				<div class="col-md-10 col-12" style="margin: auto">
					<div class="card">
						...
						<div class="divider divider-default">
							<label>상단 고정 유무:</label>
							<input type="checkbox" id="checkTop" >
							<input type="hidden" name="is_top" value="" id="checkTophidden">
						</div>


						<div class="card-body">
							<div class="row">
									<input type="hidden" name="mem_id" value="${loginUser.mem_id}gyeom">
									<div class="mb-1">
									...
									<div class="mb-1">
										<label class="form-label" for="smallInput">작성자</label> <input
											...
											name="writer" value="기민혁" type="text"
									...
									<div>
										<textarea class="textarea" name="content"
											id="notice_content" rows="20" cols="90"
	...
	<script>
		function regist_go() {
			...
			if($("#checkTop").prop("checked")){
				$("#checkTophidden").val(1);
			}else{
				$("#checkTophidden").val(0);
			}
