								...
								<div class="d-flex align-items-center flex-column" >
									<%-- <img class="img-fluid rounded mt-3 mb-2"
									  ...
									  <c:choose>
											...
											<c:otherwise>
												<img class="img-fluid rounded " src="<%=request.getContextPath()%>/resources/images/책책박사님.PNG"
...
<!-- 							</span> -->
							<div class="ms-75">
<!-- 								<div>읽은 권수</div> -->
<!-- 									<h4 class="mb-0" style="text-align: center;">63권</h4> -->
							</div>
					    </div>
...
<!-- 							</span> -->
								<div class="ms-75">
<!-- 									<div>북 포인트</div> -->
<!-- 										<h4 class="mb-0" style="text-align: center;">56점</h4> -->
								</div>
						</div>
					</div>
						<h4 class="fw-bolder border-bottom pb-50 mb-1" style="margin-top: 36px; ">&nbsp;
						<i data-feather='user' style="color:cornflowerblue; margin-bottom: 5px;"></i> 나의 정보</h4>
							<div class="info-container">
								<ul class="list-unstyled">
									<li class="mb-75" style="margin-top: 20px; font-size: 15px;"><span class="fw-bolder me-25">&nbsp;&nbsp;회원명 :</span>
										<span style="font-size: 16px;">${loginUser.mem_name} </span></li>
									<%-- <li class="mb-75" style="margin-top: 20px;"><span class="fw-bolder me-25">회원 등급:</span>
									...
									<span class="fw-bolder me-25">&nbsp;<i data-feather='chevrons-down' style="color: dodgerblue;"></i>
										    자세한 정보는 하단의 버튼을 클릭 후 확인 가능합니다.</span></li>
								</ul>
								...
								<!-- <div class="d-flex justify-content-center pt-2">
									...
									<a href="javascript:;" class="btn btn-outline-info me-1" id="myInfoEdit" data-bs-target="#editUser"
									   data-bs-toggle="modal" > 개인정보 수정
									</a> 
								<button type="button" class="btn btn-outline-danger waves-effect" id="isDrop" >회원 탈퇴</button>
								</div> -->
								...
								<div class="basic-modal" style="margin-left: 65px; margin-top: 25px; margin-bottom: 5px;">
	                               ...
	                               <a href="javascript:;" class="btn btn-outline-info me-1" id="myInfoEdit" data-bs-target="#default"
	                                	...
	                                	data-bs-toggle="modal" > 개인정보 수정 </a>  
					...
					<div class="card border-primary" style="height: 305px; padding-bottom: 0px; margin-bottom: 0px;">
						<div class="card-body" style="padding-bottom: 0px; margin-bottom: 0px;">
							<div class="d-flex justify-content-between align-items-start"  style="justify-content: center; ">
							   <div style=" margin: auto;">
									<a href="javascript:;" class="btn btn-gradient-warning " style="width:250px; height: 50px; text-align: center; padding-top: 17px;" 
										data-bs-target="#upgradePlanModal" data-bs-toggle="modal">모바일 대출증 </a> 
							   </div>	
							</div>
					        <br/>
							<ul class="ps-1 mb-2">
								<li class="mb-50">포인트 적립 내용</li>
								<li class="mb-50">포인트에 대한 자세한 내용은 아래 버튼 클릭 부탁드립니다.</li>
							</ul>
							...
							<div class="d-grid w-100 mt-2" style="padding-bottom: 0px; margin-bottom: 0px;">
								<button class="btn btn-primary" data-bs-target="#upgradePlanModal" data-bs-toggle="modal"> 포인트 적립 시기 및 내용</button>
							</div>
						</div>
					</div>
					<!-- /Plan Card -->
					...
					<ul class="nav nav-pills mb-2" style="padding-left: 20px; padding-top: 32px; margin-bottom: 0px; padding-bottom: 0px;">
						...
						<li class="nav-item">
							<a class="nav-link" id="M050505" onclick="goPage('<%=request.getContextPath()%>/main/myInfo/qna.do','M030700')">
								...
								<span class="fw-bold"> 1:1문의 내역 </span> 
							</a>
						</li>
						<li class="nav-item">
						 	<a class="nav-link" id="M050201" onclick="goPage('<%=request.getContextPath()%>/main/myInfo/bookPoint.do','M050201')">
								...
								<span class="fw-bold">포인트 내역</span>
							</a>
						</li>
					</ul>
					<!--/ User Pills -->
            ...
            <div class="modal-dialog" style="margin-top: 300px;">
                <div class="modal-content" style="margin-top: 300px;" >
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel33">비밀번호 재확인</h4>
                    ...
                    <form action="#">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onclick="show_popup();" >확인</button>
                        </div>
                    </form>
                </div>
            </div>
				...
				<div class="modal-content" style="margin-top: 150px;">
					...
					<div class="modal-body px-sm-5 " style="margin-bottom: 10px;">
						...
						<form role="form" class="row gy-1 " method="post" action="myPageForm.do" style="margin-top: 30px;">
							...
							<div class="col-12 col-md-6">
								<label class="form-label" for="modalEditUserPhone">번호</label> 
							...
							<div class="col-12 col-md-6">
								<label class="form-label" for="passwordchk">비밀번호 확인 </label>
								<span id='cfMessage' style="font-size: 13px; margin-left: 5px;"></span>
								<div class="input-group input-group-merge form-password-toggle">
							...
							<div class="col-12 col-md-6">
								<label class="form-label" for="modalEditUserInterest">관심사</label>
								<br/>		
							...
							<div class="col-12 col-md-6">
								<label class="form-label" for="modalEditUserCar">차 번호</label>
								<input type="text" id="modalEditUserCar" name="mem_car" class="form-control" placeholder=""
									   value="${loginUser.mem_car}" />
							</div>  
							<div class="col-12 ">
								<label class="form-label" for="modalEditUserAddr">주소</label>
								<input type="text" id="modalEditUserAddr" name="mem_addr" class="form-control" placeholder=""
									   value="${loginUser.mem_addr}" />
							</div>  
							<div class="col-12 text-center mt-2 pt-50">
								<button type="submit" class="btn btn-primary" id="modBtn" onclick="edit_go();">수정</button>
								<button type="reset" class="btn btn-outline-secondary" data-bs-dismiss="modal" aria-label="Close">취소</button>
							</div> 
						</form>
					</div>
				</div>
			...
			<div class="modal-dialog modal-dialog-centered modal-upgrade-plan">
				<div class="modal-content">
					...
					<div class="modal-body px-5 pb-2" style="margin-bottom: 0px;">
						<div class="text-center mb-2" style="margin-bottom: 0px;">
							...
							<div class="user-info text-center mb-3" style="margin-bottom: 0px;">
									<c:choose >
										<c:when test="${loginUser.mem_rank == 1}">
											<span class="badge bg-light-primary " style="font-size:20px;">달리는 알</span>
										</c:when>
										<c:when test="${loginUser.mem_rank == 2}">
											<span class="badge bg-light-success" style="font-size:20px;">책벌레</span>
										</c:when>
										<c:otherwise>
											<span class="badge bg-light-waring" style="font-size:20px;">책책박사</span>
										</c:otherwise>
								   </c:choose>
					...
					<div class="d-flex align-items-center flex-column" style="margin:0px;">
					    ...
					    <img class="img-fluid rounded mt-1 mb-3" src="<%=request.getContextPath()%>/resources/images/바코드.jpg"
							 height="110" width="110" alt="User avatar">
					</div>
				</div>
			</div>
	...
	/* 
	 function infoEdit(){
		...
		var check = prompt('비밀번호 재확인').text;
		console.log(res)
		alert(check);
		pwd = check;
	...
	if(prompt('비밀번호 확인')==='${loginUser.mem_pwd}'){
		alert("획인되었습니다.");
	} else {
		alert("일치하지 않습니다.");
	}
			...
			success : function(result){
				if(result == "success"){
					Swal.fire({
		 			...
		 			Swal.fire('비밀번호가 일치하지않습니다', '다시입력해주세요.', 'success');
	           } 
			},
			error:function(error){
		       Swal.fire('시스템장애로 확인이 불가합니다', '다시 시도해주세요.', 'success');
		    } 
		});
	}
</script> 
			   ...
			   Swal.fire({
				  ...
				  if (result.value) {
					  ...
					  $.ajax({
						    ...
						    url : '${webPath}/main/myInfo/dropMember.do',           // 요청할 서버url
