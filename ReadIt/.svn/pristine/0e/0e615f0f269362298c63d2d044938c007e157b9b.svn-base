                    ...
                    <div class="col-12" >
                        ...
                        <div class="card">
                            <div style="padding-top: 10px; padding-left: 10px;">
                               			<button type="button" class="btn btn-flat-primary" onclick="goPage('<%=request.getContextPath()%>/admin/bookManage/big.do','M920101','ifr')" >전체</button>
                                        <button type="button" class="btn btn-flat-secondary" value="0" onclick="search_kdc(this.value)">총류</button>
                                        <button type="button" class="btn btn-flat-success" value="1" onclick="search_kdc(this.value)"> 철학</button>
                                        <button type="button" class="btn btn-flat-danger" value="2" onclick="search_kdc(this.value)">종교</button>
                                        <button type="button" class="btn btn-flat-warning" value="3" onclick="search_kdc(this.value)">사회과학</button>
                                        <button type="button" class="btn btn-flat-info" value="4" onclick="search_kdc(this.value)">자연과학</button>
                                        <button type="button" class="btn btn-flat-dark" value="5" onclick="search_kdc(this.value)">기술과학</button>
                                        <button type="button" class="btn btn-flat-success" value="6" onclick="search_kdc(this.value)">예술</button>
                                        <button type="button" class="btn btn-flat-danger" value="7" onclick="search_kdc(this.value)">언어</button>
                                        <button type="button" class="btn btn-flat-warning" value="8" onclick="search_kdc(this.value)">문학</button>
                                        <button type="button" class="btn btn-flat-info" value="9" onclick="search_kdc(this.value)">역사</button>
                            </div>
                                  ...
                                  <div class="kb-search-input" style="float: right; padding-right: 30px;">
                                      <div class="input-group input-group-merge" style="height:30px; width:330px; margin-left: 20px;margin-top: 10px;">
										<select class="form-control form-select" name="searchType" id="searchType" style="width:18%">
											<option value="t" ${cri.searchType eq 't' ? 'selected':'' }>도서명</option>
											<option value="a" ${cri.searchType eq 'a' ? 'selected':'' }>저자</option>
											<option value="i" ${cri.searchType eq 'i' ? 'selected':'' }>ISBN</option>
											<option style = "display: none" value="k" ${cri.searchType eq 'k' ? 'selected':'' }>도서분류</option>
<%-- 											<option style = "display: none" value="i" ${cri.searchType eq 'i' ? 'selected':'' }>분류</option> --%>
										</select>
                                    ...
                                    <table class="table table-bordered text-nowrap text-center" style="table-layout: fixed">
                                        <thead>
                                            <tr style="text-align: center;">
                                                <th width="5%" style = "text-overflow:ellipsis; overflow:hidden; white-space:nowrap; padding-left: 0px; padding-right: 0px;" >순번</th>
                                                <th width="10%" style = "text-overflow:ellipsis; overflow:hidden; white-space:nowrap;" >도서분류</th>
                                                <th width="10%" style = "text-overflow:ellipsis; overflow:hidden; white-space:nowrap;" >도서번호</th>
                                                <th width="25%" style = "text-overflow:ellipsis; overflow:hidden; white-space:nowrap;" >도서명</th>
                                                <th width="15%" style = "text-overflow:ellipsis; overflow:hidden; white-space:nowrap;" >저자</th>
                                                <th width="10%" style = "text-overflow:ellipsis; overflow:hidden; white-space:nowrap;" >출판사</th>
                                                <th width="10%" style = "text-overflow:ellipsis; overflow:hidden; white-space:nowrap;" >발행연도</th>
