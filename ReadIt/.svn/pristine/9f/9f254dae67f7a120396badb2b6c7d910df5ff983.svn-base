...
<c:set var="noRentList" value="${dataMap.noRentList }" />
                        ...
                        <ul class="nav nav-pills mb-2" style="padding-top: 40px; padding-bottom: 20px;">
                            <!-- account -->
	                           <li class="nav-item">
                        	    ...
                        	    <li class="nav-item">
                            	    <a class="nav-link active" onclick="goPage('<%=request.getContextPath()%>/admin/bookManage/noRent.do','M920602','ifr')">
                                	    <i data-feather="bell" class="font-medium-3 me-50"></i>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12">
                            <div class="faq-navigation d-flex justify-content-between flex-column mb-2 mb-md-0">
                                ...
                                <ul class="nav nav-pills nav-left flex-column" role="tablist">
                                    ...
                                    <!-- payment -->
                                    <li class="nav-item">
                                        <a class="nav-link active" id="payment" data-bs-toggle="pill" href="#noRentAll" aria-expanded="true" role="tab" aria-selected="true">
                                    ...
                                    <!-- delivery -->
                                    <li class="nav-item">
                                        <a class="nav-link" id="delivery" data-bs-toggle="pill" href="#oldBook" aria-expanded="false" role="tab" aria-selected="false">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-bag font-medium-3 me-1"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path><line x1="3" y1="6" x2="21" y2="6"></line><path d="M16 10a4 4 0 0 1-8 0"></path></svg>
                                            <span class="fw-bold">고서/귀중도서</span>
                                        </a>
                                    </li>

                                    <!-- cancellation and return -->
                                    <li class="nav-item">
                                        <a class="nav-link" id="cancellation-return" data-bs-toggle="pill" href="#jungGi" aria-expanded="false" role="tab" aria-selected="false">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-refresh-cw font-medium-3 me-1"><polyline points="23 4 23 10 17 10"></polyline><polyline points="1 20 1 14 7 14"></polyline><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"></path></svg>
                                            <span class="fw-bold">정기간행물</span>
                                        </a>
                                    </li>

                                    <!-- my order -->
                                    <li class="nav-item">
                                        <a class="nav-link" id="my-order" data-bs-toggle="pill" href="#chamgo" aria-expanded="false" role="tab" aria-selected="false">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-package font-medium-3 me-1"><line x1="16.5" y1="9.4" x2="7.5" y2="4.21"></line><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>
                                            <span class="fw-bold">참고도서</span>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="noRentAll" aria-labelledby="payment" aria-expanded="true">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h4 class="mb-0">전체 목록</h4>
                                            <span>대출 불가 도서를 등록하려면 '대출 불가 도서 등록' 버튼을 누르세요. </span>
                                        </div>
                                    </div>
                                     <div class="row" style="margin:auto; margin-top: 10px; margin-bottom: 20px;">
										...
										<div class="col-md-3">
											<button type="button" class="form-control btn btn-danger btn-outline-secondary"  id="registBtn" onclick="OpenWindow('registNoRentBook.do', '대출불가도서등록',1500,800);">대출 불가 도서 등록</button>
										</div>
									</div>
...
<!-- 		                                            <th scope="col" class="text-nowrap">관리자</th> -->
<!-- 		                                            <th scope="col" class="text-nowrap">등록일</th> -->
<!-- 		                                            <th scope="col" class="text-nowrap">보관위치</th> -->
		                                        </tr>
		                                    </thead>
		                                    <tbody>
		                                    	<c:forEach items="${noRentList }" var="noRent">
		                                        <tr>
		                                            <td class="text-nowrap">${noRent.state_name }</td>
		                                            <td class="text-nowrap">
		                                            	<img src="${noRent.book_imgurl }" width="50px;" height="70px;" />
		                                            </td>
		                                            <td class="text-nowrap">${noRent.book_title }</td>
		                                            <td class="text-nowrap">${noRent.book_author }</td>
<%-- 		                                            <td class="text-nowrap">${noRent.book_imgurl }</td> --%>
<%-- 		                                            <td class="text-nowrap">${noRent.book_imgurl }</td> --%>
<%-- 		                                            <td class="text-nowrap">${noRent.book_imgurl }</td> --%>
<!-- 		                                            <td class="text-nowrap">Table cell7</td> -->
		                                        </tr>
		                                    	</c:forEach>
		                                    </tbody>
		                                </table>
                                ...
                                <!-- 고서/기증도서 -->
                                <div class="tab-pane" id="oldBook" role="tabpanel" aria-labelledby="delivery" aria-expanded="false">
                                    <!-- icon and header -->
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-tag bg-light-primary me-1">
...
<!-- 											<button type="button" class="form-control btn btn-danger btn-outline-secondary"  id="registBtn" onclick="alert('등록창 나와야합니다.');">대출 불가 도서 등록</button> -->
<!-- 										</div> -->
									</div>
...
<!-- 		                                            <td class="text-nowrap">Table cell7</td> -->
                                ...
                                <!-- 정기간행물  -->
                                <div class="tab-pane" id="jungGi" role="tabpanel" aria-labelledby="cancellation-return" aria-expanded="false">
                                    <!-- icon and header -->
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-tag bg-light-primary me-1">
...
<!-- 		                                            <th scope="col" class="text-nowrap">보관위치</th> -->
		                                    ...
		                                    <tbody>
		                                    	<c:forEach items="${noRentList }" var="noRent">
		                                    	<c:if test="${noRent.state_code == 10 }">
		                                        <tr>
		                                            <td class="text-nowrap">${noRent.state_name }</td>
		                                            <td class="text-nowrap">
		                                            	<img src="${noRent.book_imgurl }" width="50px;" height="70px;" />
...
<!-- 		                                            <td class="text-nowrap">Table cell7</td> -->
                                ...
                                <!-- 참고도서 -->
                                <div class="tab-pane" id="chamgo" role="tabpanel" aria-labelledby="my-order" aria-expanded="false">
                                    <!-- icon and header -->
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-tag bg-light-primary me-1">
...
<!-- 		                                            <th scope="col" class="text-nowrap">보관위치</th> -->
		                                    ...
		                                    <tbody>
		                                    	<c:forEach items="${noRentList }" var="noRent">
		                                    	<c:if test="${noRent.state_code == 11 }">
		                                        <tr>
		                                            <td class="text-nowrap">${noRent.state_name }</td>
		                                            <td class="text-nowrap">
		                                            	<img src="${noRent.book_imgurl }" width="50px;" height="70px;" />
