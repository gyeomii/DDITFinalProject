package bookred.socket.handler;
...
//		System.out.println("이부분 시작됨3");
//		WebSocketSession successSession = userSessionsMap.get("담긴 입력값이 없습니다.~");
//		TextMessage newMsg = new TextMessage("잘 넘어간다~");
//		successSession.sendMessage(newMsg);
//		System.out.println("이부분 시작됨1");
//		if (StringUtils.isEmpty(msg)) {
//		
//		}
//		if(!StringUtils.isEmpty(msg)) {
//			System.out.println("이부분 시작됨2");
...
//		}
	...
	private String getEmail(WebSocketSession session) {
		...
		if(loginUser == null) {
			...
			System.out.println("알림창 로그인 유저 :" + loginUser.getMem_id());
			return loginUser.getMem_id();
		}
	}
}