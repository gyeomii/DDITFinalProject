...
function smartLibraryChart(path){
	 let today = new Date();   
	...
	$.ajax({
		type : 'get',
		dataType : "json",
		url : path + "/main/myInfo/averageCount.do",
		success : function(res){
			myList = res.myList;
			totalList = res.totalList;
			thisCountList = res.thisCountList;
			lastCountList = res.lastCountList;
			console.log(myList);
			console.log(totalList);
			console.log(thisCountList);
			console.log(lastCountList);
			smartChartTwo();
		},
