        ...
        <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">시설안내</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"> <a href="#">시설안내 </a>
                                    </li>
                                </ol>
                            </div>
                        </div>
...
<!--    					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                          		  	<button type="button" onclick="change1();" class="btn btn-gradient-secondary" style="width: 33%;">1 층</button> 
                          		  	<button type="button" onclick="change2();" class="btn btn-gradient-secondary" style="width: 33%;">2 층</button> 
                          		  	<button type="button" onclick="change3();" class="btn btn-gradient-secondary" style="width: 33%;">3 층</button>
                            </div>
          ...
          <div class="tab-content pt-1">
            <div class="tab-pane active" id="home-fill" role="tabpanel" aria-labelledby="home-tab-fill">
	                               	&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<img id="img1" src= "<%=request.getContextPath()%>/resources/images/lg1.PNG" />
<!-- 	                         <div class="card-header"> -->
<!-- 	                               	<h4 class="card-title" style ="color: darkblue; font-weight: bold;">&nbsp;&nbsp; <i data-feather='chevrons-right' style="color: darkblue"></i>&nbsp;&nbsp;1층  안내도 </h4> -->
	                               	
<!-- 	                         </div> -->
            </div>
            <div class="tab-pane" id="profile-fill" role="tabpanel" aria-labelledby="profile-tab-fill">
	                               	&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<img id="img1" src= "<%=request.getContextPath()%>/resources/images/lg2.PNG" />
<!--              <div class="card-header"> -->
	                          		  
<!-- 	                               	<h4 class="card-title" style ="color: darkblue; font-weight: bold;">&nbsp;&nbsp; <i data-feather='chevrons-right' style="color: darkblue"></i>&nbsp;&nbsp;2층  안내도 </h4> -->
<!-- 	                               	<br/> -->
<!-- 	                               	<br/> -->
...
<!-- 	                         </div> -->
            ...
            <div class="tab-pane" id="messages-fill" role="tabpanel" aria-labelledby="messages-tab-fill">
	                               	&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<img id="img1" src= "<%=request.getContextPath()%>/resources/images/lg3.PNG" />
<!--              <div class="card-header"> -->
	                          		  
<!-- 	                               	<h4 class="card-title" style ="color: darkblue; font-weight: bold;">&nbsp;&nbsp; <i data-feather='chevrons-right' style="color: darkblue"></i>&nbsp;&nbsp;3층  안내도 </h4> -->
<!-- 	                               	<br/> -->
<!-- 	                               	<br/> -->
