		...
		<div class="content-header row">
             <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">희망 도서 신청</h2>
                        <div class="breadcrumb-wrapper">
                           <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active"> <a href="#">희망 도서 신청 </a>
                              </li>
                            </ol>
                        </div>
                    </div>
	            ...
	            <div class="col">
	                <div class="card knowledge-base-bg text-center" style=" height: 200px; background-color: white !important;  background-image: url('${webPath}/resources/vuexy/html-version/Bootstrap5/vuexy-html-bootstrap5-admin-template/app-assets/images/banner/parallax-4.jpg')">
	                    <div class="card-body" style="padding-top: 50px;">
	                        <h2 class="text-primary">희망 도서 신청</h2>
	                        <p class="card-text mb-2">
	                            <span class="fw-bolder">도서 신청을 누른 후 도서를 검색해주세요</span>
	                        </p>
	                        <div class="kb-search-input" >
	                            <div class="input-group input-group-merge" style="height:40px; width:700px;">
	                            	<c:choose>
	                            		<c:when test="${loginUser != null }">
		                                	<input type="button" class="form-control btn btn-primary" value="도서 신청" style="width:40%; " id="searchBtn" onclick="OpenWindow('search.do','도서검색',1400,800);"/>
	                            		</c:when>
	                            		<c:when test="${loginUser eq null }">
		                                	<input type="button" class="form-control btn btn-primary" value="도서 신청" style="width:40%;" id="searchBtn" onclick="doAlert();"/>
	                            		</c:when>
	                            	</c:choose>
	                            </div>
	                       </div> 
						...
						<div class="bs-stepper-header justify-content-center">
						    <div class="step" data-target="#step-cart" role="tab" id="step-cart-trigger">
						        <button type="button" class="step-trigger" aria-selected="true">
						            ...
						            <span class="bs-stepper-label">
						                <span class="bs-stepper-title">신청완료</span>
						            </span>
						        </button>
						    </div>
						    <div class="line">
						    ...
						    <div class="step" data-target="#step-address" role="tab" id="step-address-trigger">
						        <button type="button" class="step-trigger" aria-selected="true">
						            ...
						            <span class="bs-stepper-label">
						                <span class="bs-stepper-title">확인중</span>
						            </span>
						        </button>
						    </div>
						    <div class="line">
						    ...
						    <div class="step" data-target="#step-address" role="tab" id="step-address-trigger">
						        <button type="button" class="step-trigger" aria-selected="true">
						            ...
						            <span class="bs-stepper-label">
						                <span class="bs-stepper-title">입고 승인/거절</span>
						            </span>
						        </button>
						    </div>
						    <div class="line">
						    ...
						    <div class="step" data-target="#step-payment" role="tab" id="step-payment-trigger">
						        <button type="button" class="step-trigger" aria-selected="true">
						            ...
						            <span class="bs-stepper-label">
						                <span class="bs-stepper-title">입고중</span>
						            </span>
						        </button>
						    </div>
						    <div class="line">
						    ...
						    <div class="step" data-target="#step-payment" role="tab" id="step-payment-trigger">
						        <button type="button" class="step-trigger" aria-selected="true">
						            ...
						            <span class="bs-stepper-label">
						                <span class="bs-stepper-title">입고완료</span>
						            </span>
						        </button>
						    </div>
						    <div class="line">
						    ...
						    <div class="step" data-target="#step-payment" role="tab" id="step-payment-trigger">
						        <button type="button" class="step-trigger" aria-selected="true">
						            ...
						            <span class="bs-stepper-label">
						                <span class="bs-stepper-title">대출가능</span>
						            </span>
						        </button>
						    </div>
						</div>
...
const columnDefs = [
  ...
  {headerName:"도서제목",field: "wish_title",width:550, cellClass:""},
  {headerName:"저자",field: "wish_author",width: 200, cellClass:""},
  {headerName:"출판사",field: "wish_publisher",width: 150, cellClass:""},
  {headerName:"신청일",field: "wish_regdate",width: 120, cellClass:""},
  {headerName:"신청자",field: "mem_id",width:100, cellClass:""},
  {headerName:"상태",field: "wish_state",width:100, cellClass:""}
];
const rowData = [];
