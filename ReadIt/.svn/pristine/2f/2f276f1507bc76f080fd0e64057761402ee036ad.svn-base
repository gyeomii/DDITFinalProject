                                ...
                                <ul class="nav nav-pills nav-left flex-column" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="payment" data-bs-toggle="pill" href="#lossBook" aria-expanded="true" role="tab" aria-selected="true">
                                            ...
                                            <span class="fw-bold">훼손 및 분실</span>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="lossBook" aria-labelledby="payment" aria-expanded="true">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h4 class="mb-0">훼손 및 분실 목록</h4>
                                            <span>훼손 및 분실 도서를 등록하려면 '훼손 및 분실도서 등록' 버튼을 누르세요. </span>
                                        </div>
                                    </div>
...
<!-- 											<button type="button" class="form-control btn btn-danger btn-outline-secondary"  id="registBtn" onclick="OpenWindow('registForm.do','공지등록',800,700);">회손 및 분실도서 등록</button> -->
											<button type="button" class="form-control btn btn-danger btn-outline-secondary"  id="registBtn" onclick="OpenWindow('registLossBook.do', '훼손 및 분실도서 등록',1500,800);">훼손 및 분실도서 등록</button>
										</div>
									</div>
		                                ...
		                                <table class="table mb-0">
		                                    <thead>
		                                        <tr>
		                                            ...
		                                            <th scope="col" class="text-nowrap">이미지</th>
		                                            <th scope="col" class="text-nowrap">입고 유형</th>
		                                            <th scope="col" class="text-nowrap">도서명</th>
		                                            <th scope="col" class="text-nowrap">저자</th>
		                                            <th scope="col" class="text-nowrap">출판사</th>
		                                            <th scope="col" class="text-nowrap">입고 등록일</th>
		                                        </tr>
		                                    </thead>
		                                    <tbody>
		                                        <tr>
