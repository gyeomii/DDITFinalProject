...
<div class="container" style="margin-top: 30px;" style="font-family: 'Noto Sans KR', sans-serif;">
	<div class="row">
		<div class="col-6">
		    ...
		    <!--/ Knowledge base Jumbotron -->
		    <hr/>
			<div id="searchResult" style="overflow: auto;height: 530px; background-image: url('${webPath}/resources/img/검색결과.png')">
				<!-- searchList Start -->
			</div>
			<hr/>
		</div>
		<div class="col-6">
			<div class="card-header">
				<h4 class="card-title">비치희망도서 신청</h4>
				<p class="card-text">
					...
					<div class="row">
						...
						<div class="col-12">
							<div class="mb-1">
        	                    ...
        	                    <input type="hidden" id="form-img" name="book_imgurl" class="form-control" placeholder="이미지경로" />
						...
						<div class="col-12">
							<div class="mb-1">
    	                        <label class="form-label" for="helperText">출판연도</label>
		        	            <input type="text" id="form-pubDate" name="publishdate" class="form-control" placeholder="비고" />
            	                <p><small class="text-muted">출판년도를 입력하는 란입니다.</small></p>
                	        </div>
						</div>
					</div>
