...
<!--                                 </li> -->
                            ...
                            <c:if test="${empty dataList }">
                            	<h4 class="card-header">신청한 희망도서가 없습니다. </h4>
                            </c:if>
                            <c:if test="${!empty dataList }">
                                <h4 class="card-header">비치 희망도서 신청 목록</h4>
                            </c:if>
													...
													<tr>
														...
														<c:if test="${wishBookList.wish_state eq 0}">
															...
															<td style="text-align: center;">
																<span class="badge badge-light-primary">신청완료</span>
															</td>
															<td>
															</td>
														</c:if>
														<c:if test="${wishBookList.wish_state eq 5}">
															...
															<td style="text-align: center;">
																	<span class="badge badge-light-warning">입고완료</span>
															</td>
															<td style="text-align: center;">
																...
																<span id="'${wishBookList.isbn}'">장바구니담기</span>
																</button>
															</td>
														</c:if>
													</tr>
