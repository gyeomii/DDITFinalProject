			...
			<div class="col-lg-3 col-sm-6">
				<div class="card">
					<div
						class="card-body d-flex align-items-center justify-content-between">
						<div>
							<h3 class="fw-bolder mb-75">나의 관심사 변경</h3>
					...
					<div class="col-12 col-md-4">
						<div class="card standard-pricing popular text-center">
							<div class="card-body" style="height: 660px">
								...
								<%-- 							           <iframe width="280" height="320" src="${movie.mo_img}" title="[극장판 짱구는 못말려 : 수수께끼! 꽃피는 천하떡잎학교] 메인예고편 9월 28일 대개봉!"  autoplay; frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> --%>
								...
								<ul class="list-group list-group-circle text-start">
									<li class="list-group-item">제목 : ${movie.mo_title}</li>
									<c:choose>
										<c:when test="${movie.mo_genre eq 0}">
											<li class="list-group-item">장르 : 애니메이션</li>
										</c:when>
										<c:when test="${movie.mo_genre eq 1}">
											<li class="list-group-item">장르 : 공포(호러)</li>
										</c:when>
										<c:when test="${movie.mo_genre eq 2}">
											<li class="list-group-item">장르 : 다큐멘터리</li>
										</c:when>
										<c:when test="${movie.mo_genre eq 3}">
											<li class="list-group-item">장르 : 코미디</li>
										</c:when>
										<c:when test="${movie.mo_genre eq 4}">
											<li class="list-group-item">장르 : 액션</li>
										</c:when>
										<c:when test="${movie.mo_genre eq 5}">
											<li class="list-group-item">장르 : SF</li>
										</c:when>
									</c:choose>
									<li class="list-group-item">평점 : ${movie.mo_rating}</li>
								</ul>
								<!-- <button class="btn w-100 btn-primary mt-2 btn-open-popup "
									id="show">영화 예고편 보기</button> -->
			...
			<div class="modal-dialog modal-upgrade-plan" style="margin: 5%;">
				<div class="modal-content" style="width: 1280px; height: 720;">
					...
					<iframe width="1280" height="720" id="movie_preview"
						...
						title="[극장판 짱구는 못말려 : 수수께끼! 꽃피는 천하떡잎학교] 메인예고편 9월 28일 대개봉!"
