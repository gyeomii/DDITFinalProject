		 ...
		 <ul class="nav nav-pills mb-2">
                     <li class="nav-item">
                         <a class="nav-link active" onclick="goPage('<%=request.getContextPath() %>/admin/userManage/adminList.do','M910100','ifr');">
                             ...
                             <span class="fw-bold">회원 조회</span></a>
                     </li>
       </ul>
                ...
                <h1 style="color:white; font-weight: bold;">북적북적 도서관 회원 현황</h1>
                </div>
				...
				<div class="item"></div><div class="item"></div>
                 ...
                 <div class="item">
                 전체회원수<br/>
                 <h2 style="color:white;">${memCount[0]} 명</h2>
                 </div>
                 <div class="item" >
                 책책박사 회원<br/>
                 <h2 style="color:white;">${memCount[1]} 명</h2>
                </div>
                 <div class="item">
                 책벌레 회원<br/>
                 <h2 style="color:white;">${memCount[2]}  명</h2>
                </div>
                 <div class="item">
                  알회원<br/>
                 <h2 style="color:white;">${memCount[3]}  명</h2>
                </div>
                 <div class="item">
                  신규회원(월)<br/>
                 <h2 style="color:white;">${memCount[4]} 명</h2>
                </div>
                 <div class="item">
                  탈퇴회원<br/>
                 <h2 style="color:white;">${memCount[5]} 명</h2>
                </div>
                 <div class="item">
                </div>
                 <div class="item">
					...
					<table class="table" style="text-align: center">
						...
						<tbody>
							<c:forEach items="${memberList }" var="member" varStatus="status">
								...
								<tr
									onclick="OpenWindow('memDetail.do?from=list&mem_id=${member.mem_id }','상세보기',800,950);">
