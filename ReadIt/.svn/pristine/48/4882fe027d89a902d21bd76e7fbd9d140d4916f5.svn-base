...
<body>
		...
		<div class="container">
			<div class="card" style="margin-top: 30px; min-height: 800px; min-width: 750px;">
				<div style="float: left;"></div>
				<div class="demo-inline-spacing" style="float: right;">
					<span class="badge bg-primary"> <i data-feather="star" class="me-25"></i> <span>자주 묻는 질문</span></span>
				</div>
				<div style="float: right;">
					<h3 class="card-title" style="text-align: center; font-style: oblique;">${oftenQna.oq_title}</h3>
				</div>
				...
				<div class="card-body">
					<div class="d-flex" style="float: right; padding-right: 30px;">
						...
						<div class="author-info">
							...
							<small><a href="#" class="text-body">${oftenQna.oq_writer}</a></small>
							<span class="text-muted ms-50 me-25">|</span>
							<small class="text-muted">작성일</small>
							<small><a href="#" class="text-body"><fmt:formatDate value="${oftenQna.oq_regdate }" pattern="yyyy-MM-dd"/></a></small>
						</div>
					</div>
					<br/>
					<hr>
					<div class="author-info" style="padding: 40px; min-height: 500px;">${oftenQna.oq_content}</div>
					<div class="form-group col-sm-12">
							<div class="card card-outline card-success">	
								<div class="card-footer">
									<div class="row">
										<!-- 첨부파일 썸네일 -->
										<c:forEach items="${oftenQna.attachList }" var="attach">
					...
					<div class="dropdown blog-detail-share">
						<button type="button" id="modifyBtn" class="btn btn-success" onclick="modify_go('${oftenQna.oq_no}');">수 정</button>
						<button type="button" id="removeBtn" class="btn btn-warning" onclick="remove_go('${oftenQna.oq_no}');">삭 제</button>
	...
	<script>
		function modify_go(oq_no) {
			location.href = "modifyForm.do?oq_no=" + oq_no;
		}

		function remove_go(oq_no) {
			location.href = "remove.do?oq_no=" + oq_no;
		}
