                ...
                <div class="row">
                    <div class="col-12">
                        <ul class="nav nav-pills mb-2" style="padding-top: 40px; padding-bottom: 20px;">
                            <!-- account -->
                           <li class="nav-item">
                                <a class="nav-link active" onclick="goPage('<%=request.getContextPath()%>/admin/bookManage/location.do','M920401','ifr')">
                            ...
                            <!-- notification -->
                            <li class="nav-item">
                                <a class="nav-link " onclick="goPage('<%=request.getContextPath()%>/admin/bookManage/locationCode.do','M920402','ifr')">
                        ...
                        <!-- recent device -->
                        <div class="card">
							<iframe src="<%=request.getContextPath()%>/main/info/facility.do"  style="width:100%;height:85vh; overflow-x:hidden"></iframe>
                        </div>
                        <!-- / recent device -->
