...
/*
	...
	*/
//@Component("bookredTask")
public class Scheduler {	
	
	@Autowired
	RentBackService rentBackService;
	
	@Autowired
	ReserveService reserveService;
	
	public void rentOverdue() throws SQLException {
		System.out.println("scheduler 실행~ 반납일 만료기한 체크합니다.");
		rentBackService.rentDateOverdue();
	}
	
	public void reserveOverdueCancle() throws SQLException {
		System.out.println("scheduler 실행~ 예약 만료 체크합니다.");
		reserveService.updateResveListToCancel();
	}
}
