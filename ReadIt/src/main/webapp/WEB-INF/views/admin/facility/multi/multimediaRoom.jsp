		   				 ...
		   				 <div class="card-body"> 
		   					<div class="row justify-content-between" style="margin-left: 205px;">
			   						<div class="col-md-5 mb-1" style="margin:0 auto;">
										<label class="form-label" for="fp-default"><h3 class="fw-bolder"> 📅 날짜 선택</h3></label>
			   					...
			   					<div class="col-md-5 mb-1" style="margin: auto; margin-left: -50px; margin-right: 180px;">
			   					  	<label class="form-label" for="fp-default"><h3 class="fw-bolder"> ✔️ 멀티 미디어실 선택</h3></label>	
...
<div id="readyModal"  >
	<div id="readyContent" style="margin-top: 80px;">
		<div class="card" >
			...
			<div class="card-header" style="text-align:center; margin-top: 17px; margin-bottom: 0px;"><h2>&nbsp;&nbsp;&nbsp;🙎‍♂️🙎‍♀️ 이용자 정보</h2></div>
			<div class="container" style="width: 260px; margin-left: 77px;">
				<div style="margin-top: 20x;">
					...
					<div class="card-body text-white bg-info" style="display:inline-block;border: 1px solid; width:650px; margin-top: 5px; margin-left: 47px;">
						<div id="9h">
							<div style="margin-top: -3px;">예약 없음</div>
						</div>	
					</div>
				</div>
				<br>
				...
				<div class="card-footer d-flex  justify-content-end" style="margin-top: 10px;">
					<div class="col-2">
					<button type="button"  class="btn btn-outline-primary" style="width:100px; margin-left: 420px;" onclick="closeModal();">닫기</button>
				</div>
			</div>
...
// 		            	alert(res[length-2])
		            	...
		            	if(res[length-2]==="m1"||res[length-2]==="m2"){
		            		...
		            		html +=`<h4 class="card-title">(\${res[length-1]})일멀티미디어(\${res[length-2]})실</h4>`
		            		html +=`</div>`
							for(var i =1; i<=4; i++){
							...
							area.append(html) 
		            				...
		            				subHtml +=`<h4 class="card-title">멀티미디어(\${res[length-1]})실</h4>`
		            				subHtml +=`</div>`
		            		for(var i =1; i<=2; i++){
