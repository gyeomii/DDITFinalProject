...
<body>
 ...
 <div class="container">
  ...
  <div class="accordion accordion-margin mt-2" id="info-qna" >
                                        <div class="card accordion-item">
                                            <h2 class="accordion-header" id="paymentOne">
                                                <button class="accordion-button" data-bs-toggle="collapse" role="button" data-bs-target="#info-one" 
                                                        aria-expanded="true" aria-controls="info-one"
                                                			   style="font-size: 20px " >
                                                    	&nbsp;&nbsp;&nbsp;책,&nbsp;&nbsp;사람,&nbsp;&nbsp;미래와의 만남이 즐거운 도서관 &nbsp;<i data-feather='home' 
                                                    	style="color: saddlebrown"></i>
                                                </button>
                                            </h2>


                                            <div id="info-one" class="accordion-collapse collapse show" aria-labelledby="paymentOne" data-bs-parent="#info-qna"
                                            	 style="">
                                                <div class="accordion-body"  style="line-height:50px">
                                             		    &nbsp;&nbsp;&nbsp;대전 광역시 북적북적 도서관은 지식 정보 활용과 문화 활동의 마당으로  여러분과 함께 누리는 공간입니다
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="author-info">
                                                <h6 class="fw-bolder mb-25">기민</h6>
                                                <p class="card-text">10월 22일, 2022</p>
                                                <p class="card-text">
                                                    	책을 꼭 5권만 빌려야 하나요? <br/>
                                                    	배송으로 많이는 못 빌리나요??ㅡㅡ
                                                </p>
                                                <a href="#">
                                                    <div class="d-inline-flex align-items-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" 
                                                        	...
                                                        	class="feather feather-corner-up-left font-medium-3 me-50"><polyline points="9 14 4 9 9 4">
                                                        	</polyline><path d="M20 20v-7a4 4 0 0 0-4-4H4"></path></svg>
                                                        <span>Reply</span>
                                                    </div>
                                                </a>
                                            </div>
                            ...
                            <div class="col-12 mt-1">
                                <h6 class="section-label mt-25">댓글을 남겨주세요</h6>
                                <div class="card">
                                    <div class="card-body">
                                        <form action="javascript:void(0)" class="form">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-12">
                                                    <div class="mb-2">
                                                        <input type="email" class="form-control" placeholder="작성시간">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <textarea class="form-control mb-2" rows="4" placeholder="댓글"></textarea>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-check mb-2">
                                                        <input type="checkbox" class="form-check-input" id="blogCheckbox">
                                                        <label class="form-check-label" for="blogCheckbox">대댓글 알림 어쩌구~</label>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <button type="submit" class="btn btn-primary waves-effect waves-float waves-light">작성 </button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
