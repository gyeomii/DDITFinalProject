                ...
                <div class="row">
                    <div class="col-12">
                         <ul class="nav nav-pills mb-2" style="padding-top: 40px; padding-bottom: 20px;">
                            <!-- account -->
                           <li class="nav-item">
                                <a class="nav-link active " onclick="goPage('<%=request.getContextPath()%>/admin/bookManage/best.do','M920200','ifr')">
                            ...
                            <!-- notification -->
                            <li class="nav-item">
                                <a class="nav-link " onclick="goPage('<%=request.getContextPath()%>/admin/bookManage/recommend.do','M920201','ifr')">
                        ...
                        <!-- security -->
		<h1>베스트 도서 리스트가 나와야함. 단, 관리자는 리스트를 수정 및 삭제 할 수 있어야 할 것 같음.</h1>
                        <!-- recent device -->
                        <div class="card">
                            <div style="padding-top: 10px; padding-left: 10px;">
                                <button type="button" class="btn btn-flat-primary">전체 베스트</button>
                                        <button type="button" class="btn btn-flat-success">월간 베스트</button>
                            </div>
