                        ...
                        <ul class="nav nav-pills mb-2" style="padding-top: 40px; padding-bottom: 20px;">
                            <!-- account -->
	                           <li class="nav-item">
                        	    ...
                        	    <li class="nav-item">
                            	    <a class="nav-link active" onclick="goPage('<%=request.getContextPath()%>/admin/bookManage/getBook.do','M920604','ifr')">
                                	    <i data-feather="bell" class="font-medium-3 me-50"></i>
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="noRentAll" aria-labelledby="payment" aria-expanded="true">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h4 class="mb-0">도서 입고 목록</h4>
                                            <span>입고내역를 등록하려면 '입고 등록' 버튼을 누르세요. </span>
                                        </div>
                                    </div>
...
<!-- 											<button type="button" class="form-control btn btn-danger btn-outline-secondary"  id="registBtn" onclick="OpenWindow('registForm.do','공지등록',800,700);">회손 및 분실도서 등록</button> -->
											<button type="button" class="form-control btn btn-danger btn-outline-secondary"  id="registBtn" onclick="alert('등록창 나와야합니다.');">입고 등록</button>
										</div>
									</div>
