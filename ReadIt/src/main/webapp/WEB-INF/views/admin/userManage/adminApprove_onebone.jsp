								...
								<tr>
									...
									<c:choose>
										<c:when test="${adminList.joincheck eq 0 }">
											<td>
												<span class="badge badge-light-info" onclick="alert('dd');"><a>승인</a></span>
												<span class="badge badge-light-danger" onclick="alert('dd');"><a>거절</a></span>
											</td>
										</c:when>
