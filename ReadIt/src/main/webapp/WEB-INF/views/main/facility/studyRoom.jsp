...
<body style="font-family: 'Noto Sans KR', sans-serif;">
	...
	<div class="container">
		<div class="d-flex align-items-center">
			<div style="margin-top: 20px;">
				<h1 style="display: inline;">&nbsp;🏛️ 시설공간</h1>
				<span class="text-success" style="display: inline; font-size: 19px; font-weight: bold;"> &nbsp;- 독서실</span>
			</div>
		</div>
			<br>
		<div class="card">
					...
					<div class="resize-triggers">
						<div class="expand-trigger">
							<div align="center"
								...
								<br> <br> <br> <br> <br> <br>
								<div>
									<h2 style="display: inline;">전체 좌석</h2>
									<p class="text-primary"
										style="display: inline; font-size: 40px">150</p>
									<h2 style="display: inline;">석</h2>
								</div>
								<br> <br>
								<div>
									<h2 style="display: inline;">잔여 좌석</h2>
	...
	<h1>&nbsp;🪑 독서실 좌석 (공통)</h1>
		<div class="card" style="min-height: 700px; margin-top: 20px; padding-bottom: 0px; margin-bottom: 0px;">
			<br>
			<br>
			<br>
			<br>
			<div style="text-align: center; margin-bottom: 0px; padding-bottom: 0px; margin-top: 30px;" >
			<img alt="seat" src="../../resources/img/도서관 좌석.PNG">
			</div>
