...
<div class="container">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">상세 검색</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">상세검색
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card knowledge-base-bg text-center" style=" height: 250px; background-color: white !important;  background-image: url('<%=request.getContextPath()%>/resources/vuexy/html-version/Bootstrap5/vuexy-html-bootstrap5-admin-template/app-assets/images/banner/parallax-4.jpg')">
                                <div class="card-body" style="padding-top: 50px;">
                                    <h2 class="text-primary">상세 검색</h2>
                                    ...
                                    <div class="kb-search-input" >
                                      <div class="input-group input-group-merge" style="height:60px; width:700px;">
										...
										<input type="text" class="form-control" id="searchText" style="width:60%" name="keyword"  value="${param.keyword }" placeholder="도서명을 검색하세요" onkeyup="if(window.event.keyCode==13){search_go(1)}"/>
                                       </div>
                                   </div>
                                  </div>
                                </div>
   ...
   <script>
	function search_go(page,url) {
	   if(!url) url="<%=request.getContextPath()%>/main/search/deepSearch.do";
				var jobForm = $('#jobForm');
