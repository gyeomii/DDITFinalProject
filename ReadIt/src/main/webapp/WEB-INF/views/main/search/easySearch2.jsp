                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="#">도서검색</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="card-body" style="padding-top: 50px;">
                                    ...
                                    <p class="card-text mb-2">
                                      ...
                                      <div class="input-group input-group-merge" style="height:60px; width:700px;">
										...
										<input type="text" class="form-control" id="searchText" style="width:60%" name="keyword"  value="${param.keyword }" placeholder="도서명을 검색하세요" onkeyup="if(window.event.keyCode==13){searchAjax()}"/>
                                       </div>
                                   </div>
                                </div>
                            </div>
