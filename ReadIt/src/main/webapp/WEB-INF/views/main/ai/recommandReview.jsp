...
<!--                                     <div> -->
<!--                                         <h3 class="fw-bolder mb-75">나의 MBTI : ESFJ</h3> -->
<!--                                         <span>MBTI</span> -->
<!--                                     </div> -->
...
<!--                                 <div class="card-body d-flex align-items-center justify-content-between"> -->
<!--                                     <div> -->
<!--                                         <h3 class="fw-bolder mb-75">나의 MBTI 변경</h3> -->
...
<!-- 							</div> -->
            ...
            <div style="text-align: center;">
	           <button type="button" class="btn  btn-primary" onclick="goPage('${webPath}/main/facilitySpace/multiRoom.do','M060200','ifr')">멀티미디어실에서 추천 영화 즐기기</button>
            </div>
</div>
