...
<div class="container">
                    ...
                    <div class="card row">
                        <div class="card-body align-self-center" >
                            ...
                            <!-- connection -->
                            <li class="nav-item">
                                <a class="nav-link active" onclick="goPage('<%=request.getContextPath()%>/main/ai/recommandFace.do','M040600','ifr');" >
                      ...
                      <div class="row">
                        <div class="col-12">
<!--                             <div class="card"> -->
                                <div class="card-body d-flex align-items-center justify-content-between" style="text-align: center;">
                                	<img src="<%= request.getContextPath()%>/resources/genie/ai.jpg" height="400px;" style="margin: 0 auto;">
<!--                                 	<div class="col-3"> -->
<!-- 	                                	<div class="row"> -->
<!-- 	                                		<div class="col-2"> -->
...
<!-- 			                                        <h3 class="fw-bolder" style="margin-top: 10px;">나와 닮은 연예인 : 손흥민</h3> -->
<!-- 			                                    </div> -->
<!-- 	                                		</div> -->
<!-- 	                                	</div> -->
<!--                                 	</div> -->
<!--                                 	<div> -->
<%-- 	                                    <img src="<%= request.getContextPath()%>/resources/genie/genie1.png" width="100px;"> --%>
<!--                                 	</div> -->
                                </div>
                            </div>
<!--                         </div> -->
					           ...
					           <h3> </h3>
					            <div class="annual-plan">
					                 <div class="plan-price mt-2">
					                    ...
					                    <h6 class="text-success">${book.book_title}</h6>
...
<!-- 					                <li class="list-group-item">책 설명 ? 몰라</li> -->
					            </ul>
