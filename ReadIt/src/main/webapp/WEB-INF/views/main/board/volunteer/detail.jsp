			...
			<div class="card" style="margin-top: 30px; min-height: 600px; min-width: 750px;">
				...
				<sec:authorize access="hasRole('ROLE_ADMIN')"> 			
						<button type="button" class="btn btn-warning waves-effect waves-float waves-light" data-bs-toggle="modal" id="applyList"
								style="margin-left: 10px; margin-right: 170px;" data-bs-target="#shareProject" >신청자 목록 확인</button>
				</sec:authorize>			
				
				<button type="button" id="cancelBtn" class="btn btn-secondary" onclick="CloseWindow();" style="float: right; margin: 1px;">닫 기</button>
				<button type="button" onclick="javascript:application_go('${volBoard.vb_no}')" id="application" class="btn btn-info" style="float: right; margin: 1px;">신청하기</button>
				
				<sec:authorize access="hasRole('ROLE_ADMIN')"> 		
							<button type="button" id="modifyBtn" class="btn btn-success" onclick="modify_go('${volBoard.vb_no}');" style="float: right; margin: 1px;">수 정</button>
							<button type="button" id="removeBtn" class="btn btn-danger" onclick="remove_go('${volBoard.vb_no}');" style="float: right; margin: 1px;">삭 제</button> 
				</sec:authorize>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content" style="min-height: 400px;">
                            ...
                            <div class="modal-body" style="margin: 10px; margin-left: 60px; margin-right: 60px;" >
                                ...
                                <p class="text-center" style="margin-bottom: 12px; margin-top:25px; font-size: 15px;">해당 봉사 정원에 맞추어서 <br> 봉사 신청자를 승인해주세요. </p>
                                	<!-- <i data-feather='check-circle' style="color: forestgreen;"></i> -->

                                <p class="fw-bolder pt-50 mt-2" style="font-size: 16px; margin-bottom: 0px;"><i data-feather='users' style="color: dodgerblue;"></i>&nbsp;신청자</p>
	                                                	...
	                                                	<input type="hidden" id="mem_id" name="mem_id" value="${volList.mem_id}">
		                                           		<label class="form-label fw-bolder font-size font-small-4 mb-50" for="addMemberSelect"> &nbsp;승인 여부</label>
							                                <select class="select2 form-select" id="is_approved" style="width: 120px;" name="is_approved">
							                                	 <option value="0" ${volList.is_approved == '0' ? 'selected="selected"' : '' }>승인대기</option>
							                                     <option value="1" ${volList.is_approved == '1' ? 'selected="selected"' : '' }>승인</option>
							                                     <option value="2" ${volList.is_approved == '2' ? 'selected="selected"' : '' }>승인거절</option>
							                                </select>
		                                            </div>
		                                        </div>
		                                    </li>
