	   ...
	   <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">분실물 찾기</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="#">분실물 찾기</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
...
<sec:authorize access="hasRole('ROLE_ADMIN')"> 
	<div class="col-md-3">
		<button type="button" class="form-control btn btn-primary btn-outline-secondary" id="registBtn" style="width: 150px; border-left-width: 100px; margin-left: 230px;" onclick="OpenWindow('registForm.do','게시글 등록',900,850);">게시글 등록</button>
	</div>
</sec:authorize>
</div>
	<!-- Basic Tables start -->
                   ...
                   <table class="table table-bordered"  style="table-layout:fixed; text-align: center">
                       ...
                       <tbody>
                           <c:forEach items="${lostList }" var="lost" varStatus="status">
									<tr onclick="OpenWindow('detail.do?from=list&lost_no=${lost.lost_no }','상세보기',900,750);">
