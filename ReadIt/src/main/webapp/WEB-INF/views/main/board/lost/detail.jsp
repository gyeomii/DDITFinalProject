		...
		<div class="container">
			<div class="card" style="margin-top: 30px; min-height: 600px; min-width: 750px;">
				...
				<div class="demo-inline-spacing" style="float: right;">
					<span class="badge bg-primary"> <i data-feather="star" class="me-25"></i> <span>분실물 찾기</span></span>
				</div>
				...
				<div class="card-body">
					...
					<div class="dropdown blog-detail-share" style="padding-left: 450px;">
						<sec:authorize access="hasRole('ROLE_ADMIN')"> 
							<button type="button" id="modifyBtn" class="btn btn-success" onclick="modify_go('${lost.lost_no}');">수 정</button>
							<button type="button" id="removeBtn" class="btn btn-warning" onclick="remove_go('${lost.lost_no}');">삭 제</button>
						</sec:authorize>	
