...
<body>
			...
			<div class="card card-outline card-info">
				<div class="col-md-10 col-12" style="margin: auto">
					<div class="card">
						...
						<div class="card-body">
							<div class="row">
								<form enctype="multipart/form-data" role="form" method="post" action="regist.do"
									name="registForm">
									...
									<div class="mb-1">
										<label class="form-label" for="smallInput">작성자</label> <input
											...
											name="writer" value="${event.ev_writer}"
											type="text" placeholder="Normal Input">
									</div>
									<div>
									...
									<div>
										<textarea class="textarea" name="content"
											id="event_content" rows="20" cols="90"
	...
	window.onload=function(){
		summernote_go($('#event_content'),'<%=request.getContextPath()%>');
