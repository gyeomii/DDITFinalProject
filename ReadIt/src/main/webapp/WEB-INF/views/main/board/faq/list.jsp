...
<div class="row" style="margin:auto; padding-bottom: 20px;">
	<div class="col-md-3">
		<button type="button" class="form-control btn btn-primary btn-outline-secondary  id="registBtn" onclick="OpenWindow('registForm.do','자주 묻는 질문 등록',900,850);">자주 묻는 질문 등록</button>
	</div>
		...
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h1 class="card-title">자주 묻는 질문</h1>
				</div>
					...
					<table class="table table-bordered"  style="table-layout:fixed; text-align: center">
						...
						<tbody>
							<c:forEach items="${oftenQnaList }" var="oftenQna" varStatus="status">
								<tr onclick="OpenWindow('detail.do?from=list&oq_no=${oftenQna.oq_no }','상세보기',800,700);">
