	...
	<div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">MY 리뷰</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">MY 리뷰
                                    </li>
									<li class="breadcrumb-item active"><a href="#">리뷰 미작성 도서</a>
                                    </li>
                            </div>
                        </div>
                    </div>
		...
		<div class="card">
			<div style="padding-left: 30px; padding-top: 30px;">
				<button type="button" class="btn btn-flat-primary round "
					id="reviewListBtn" onclick="acyncMovePage('<%=request.getContextPath()%>/main/myBook/reviewList.do')">나의 리뷰</button>
					...
					<div class="px-sm-5 mx-50">
						...
						<input id="modalRent_no" style="display: none;" value=""  name="rent_no">
							...
							<div class="col-lg-2 d-flex align-items-end"
								...
								<input type="button" class="btn btn-primary w-70" onclick="regist_go()" value="작성완료">
							</div>
						</form>
					</div>
				</div>
