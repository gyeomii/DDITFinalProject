     ...
     <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">도서 장바구니</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Home
                                    </li>
                                    <li class="breadcrumb-item active"> <a href="#">도서 장바구니 </a>
                                    </li>
                                </ol>
                            </div>
                        </div>
        ...
        <div class="content-wrapper container-xxl p-0">
            <div class="content-body">
                ...
                <div class="item" style="padding-top: 40px; ">
                   <c:choose>
						<c:when test="${loginUser.mem_rank == 1}">
							<span class="badge bg-light-success">알</span>
						...
						<c:otherwise>
							<span class="badge bg-light-waring">책책박사</span>
							<img src="${webPath}/resources/images/책책박사님.PNG" style="height:100px; width: auto;"/>
						</c:otherwise>
					</c:choose>
                </div>
				...
				<div class="item"></div><div class="item"></div>
                 <div class="item"></div><div class="item"></div>
                 <div class="item" >
                ${loginUser.mem_name }님의 도서 장바구니 <br/>
                <small>* 대출불가도서는 예약되지 않습니다.</small> 
                </div>
                 <div class="item">
                </div>
                 <div class="item">
                 ...
                 <div class="item">
                현재대출권수<br/>
                 <h2 style="color:white;">${rentList.size()} 권</h2>
                </div>
                 <div class="item">
                예약대출권수<br/>
                 <h2 style="color:white;">${reserveList.size()}권</h2>
                </div>
                 <div class="item">
                대출가능권수<br/>
                 <h2 style="color:white;"> ${5 - rentList.size() - reserveList.size()} 권</h2>
                </div>
                 <div class="item">
                </div>
                </div>
                    ...
                    <div class="bs-stepper-header" style=" padding-left: 900px;">
                        <div class="step" data-target="#step-cart" role="tab" id="step-cart-trigger">
                            ...
                            <button type="button" class="step-trigger" style="padding-left: 5px;">
                                ...
                                <span class="bs-stepper-label" style="margin-left: 5px;">
                                    <span class="bs-stepper-title" id="cbx_chkAll" onclick ="noCheckBox()">선택 해제</span>
                                </span>
                            </button>
                        </div>
                    </div>
						                  ...
						                  <div class="card ecommerce-card" >
						                      ...
						                      <div class="card-body" style="padding-top: 0px;">
						                          <div class="item-name" style=" width: 700px;" onclick="goPage('${webPath}/main/search/bookDetail.do?book_no=${book.book_no}','M020310','ifr');">
						                              ...
						                              <span class="item-company">도서 위치  <a href="#" class="company-name">${book.room}/${book.sector}/${book.call_number}</a></span>
...
// 				   alert("["+checkedBook[i].title + "]은 이미 대출중입니다.");
				   Swal.fire('이미대출중인도서입니다.', '['+checkedBook[i].title + ']은 이미 대출중입니다.', 'success');
				   return false;
			   }
		   }
	   }
	   ...
	   if(cob_check == 0) {
// 		      alert('선택된 도서가 없습니다');
		      Swal.fire('선택된 도서가 없습니다.', '도서를 선택해주세요.', 'success');
		      return false;
		  }
	   
	   if(cob_check > canRent){
// 		   alert("최대 " + canRent + "권 대출 가능합니다.");
		   Swal.fire('대출가능권수초과.', "최대 " + canRent + "권 대출 가능합니다.", 'success');
		   return false;
	   }
...
// 		      alert('선택된 도서가 없습니다')
   ...
   <script>
	<c:if test="${from eq 'reserve'}">
	 Swal.fire('도서가 예약 되었습니다.', '예약내역은 나의정보에서 확인가능합니다', 'success');
	</c:if>
