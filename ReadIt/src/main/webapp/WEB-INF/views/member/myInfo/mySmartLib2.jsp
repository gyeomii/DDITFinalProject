...
<div class="container" style="font-family: 'Noto Sans KR', sans-serif;">
	 <!-- BEGIN: content-->
	 <h1 class="text-primary" style="font-family: 'Noto Sans KR', sans-serif;">나의 스마트 도서관</h1>
	 <br>
			...
			<div class="col-lg-4 col-12">
			    <div class="card">
			        <div class="card-header d-flex justify-content-between pb-0">
			            <h3 class="card-title">도서 대출 권수</h3>
			        </div>
			        <div class="card-body">
			            <div class="row">
			                <div class="col-sm-2 col-12 d-flex flex-column flex-wrap text-center">
			                    <h1 class="font-large-2 fw-bolder mt-2 mb-0">${rentCount + delayCount }</h1>
			                    <p class="card-text" style="font-size: 0.8em;">읽은 도서</p>
			                </div>
			            ...
			            <div class="d-flex justify-content-between" >
			                <div class="text-center">
			                    <p class="card-text mb-50">빌린 도서</p>
			                    <span class="font-large-1 fw-bold">${rentCount }권</span>
			                </div>
			                <div class="text-center">
			                    <p class="card-text mb-50">예약 도서</p>
			                    <span class="font-large-1 fw-bold">3권</span>
			                </div>
			                <div class="text-center">
			                    <p class="card-text mb-50">연체 도서</p>
			                    <span class="font-large-1 fw-bold">${delayCount }권</span>
			                </div>
			            </div>
			        </div>
			    </div>
			...
			<div class="card">
		    	<div class="card-body">
		        	<div class="col-lg-12 col-12 d-flex justify-content-between flex-column text-end order-lg-2 order-1">
		            	<div class="card-header d-flex justify-content-between pb-0">
		             		<h3 class="card-title">슬기로운 북적북적</h3>
		         		</div>
...
<!--                     </div> -->
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="card card-transaction">
                                <div class="card-header">
                                    <div class="col-9">
                                    	<h4 class="card-title">북 포인트</h4>
                                    </div>
                                	<div class="col-3" style="text-align: right;">
                             			<div onclick="goPage('${webPath}/main/myInfo/myPage','M050200','ifr')" ><a><i data-feather='plus-square'></i><small>더보기</small></a></div>
                       				</div>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h4 class="card-title">북적북적 생활</h4>
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="row border-top text-center mx-0">
                                        <div class="col-6 border-end py-1">
                                            <p class="card-text text-muted mb-0">현재 점수</p>
                                            <h3 class="fw-bolder mb-0">25점</h3>
                                        </div>
                                        <div class="col-6 py-1">
                                            <p class="card-text text-muted mb-0">책책 박사</p>
                                            <h3 class="fw-bolder mb-0">100점</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                    	<div class="card-title">
                                    		<div class="row">
                                    			...
                                    			<div class="col-3" style="text-align: right;">
			                                       <div onclick="goPage('${webPath}/main/myBook/reviewList.do','M050302','ifr')" ><a><i data-feather='plus-square'></i><small>더보기</small></a></div>
                                    			</div>
                                    		</div>
                    ...
                    <div class="row match-height"  style="min-height: 444px;">
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h4 class="card-title">최근 6개월 대출 권수 평균</h4>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-start mb-3">
                                        <div class="me-2">
                                            <h3 class="fw-bolder">
                                                <span class="text-primary">${loginUser.mem_id }님 평균</span>
                                            </h3>
                                        </div>
                                        <div>
                                            <h3 class="fw-bolder">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-start pb-1">
                                    <div>
                                        <h4 class="card-title mb-25">분류별 도서내역 비교</h4>
                                    </div>
